...
<form action="<?= base_url ?>Cliente/editCliente" method="POST" novalidate>
    <div class="cliente">
        ...
        <input type="text" id="inputnombre" name="inputnombre" class="form-control" placeholder="nombreCliente" value="<?= $cliente[1] ?>">
        <label for="inputRfc">RFC</label>
        <input type="text" id="inputRfcC" name="inputRfc" class="form-control" placeholder="RFC" value="<?= $cliente[2] ?>">
...
<div class="col-sm-12 col-md-12 col-lg-12 gral card " style="width: 100%;height:auto">
                        ...
                        <div class="contactoCli" id="contactoCli">
                            ...
                            <div class="">
                                <div class="">
                                    ...
                                    <input type="text" id="inputnombreContactoAdd" name="inputnombreContactoAdd" class="form-control">
                        ...
                        <div class="DomClienteAdd" id="domicilioCliAdd">
                            ...
                            <div class="">
                                ...
                                <div class=" domicilioCliente">
                                    ...
                                    <input type="text" id="inputCalleModalAdd" name="inputCalleModalAdd" class="form-control">
                                    ...
                                    <select name="selectRutaModalAdd" id="selectRutaModalAdd" class="form-control">
                                        ...
                                        <option value="0">Elige una ruta</option>
                        ...
                        <div class="DomCliente" id="domicilioCli">
                            ...
                            <div class="">
                                ...
                                <div class=" domicilioCliente">
                                    ...
                                    <input type="text" id="inputCalleModal" name="inputCalleModal" class="form-control">
                                    ...
                                    <input type="text" id="coloniaCustomer" name="coloniaCustomer" class="form-control">
                        ...
                        <div class="contactoCli" id="contactoCli">
                            ...
                            <div class="">
                                ...
                                <div class="">
                                    ...
                                    <input type="text" id="inputnombreContactoEdit" name="inputnombreContactoEdit" class="form-control" value="<?= $cliente[4] ?>">
