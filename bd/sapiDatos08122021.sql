...
CREATE TABLE IF NOT EXISTS `almacen` (
  `idAlmacen` int NOT NULL COMMENT 'identificador del almacen',
...
-- Volcando datos para la tabla sapi.almacen: ~4 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `detallecompra` (
  ...
  `pesoDetalleCompra` float(6,3) DEFAULT NULL COMMENT 'peso de la compra',
  ...
  `idAlmacenEnvio` int DEFAULT NULL,
  PRIMARY KEY (`idDetalleCompra`),
  KEY `IX_Relationship2` (`idProducto`),
  CONSTRAINT `pk_producto_dCompras` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla sapi.detallecompra: ~0 rows (aproximadamente)
...
INSERT INTO `detallecompra` (`idDetalleCompra`, `idProducto`, `idCompras`, `pzDetalleCompra`, `pesoDetalleCompra`, `loteDetalleCompra`, `precioUnitarioDetalleCompra`, `subtotalDetalleCompra`, `idAlmacenEnvio`) VALUES
	(1, 1, 32123213, 11, 11.000, 11, 11.000, 121.000, 2),
	(2, 2, 32123213, 22, 22.000, 22, 22.000, 484.000, 2),
	(3, 3, 32123213, 33, 33.000, 33, 33.000, 1089.000, 2),
	(4, 5, 32123213, 44, 44.000, 44, 44.000, 1936.000, 2),
	(5, 4, 32123213, 55, 55.000, 55, 55.000, 3025.000, 2);
