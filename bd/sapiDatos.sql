...
CREATE DATABASE IF NOT EXISTS `sapi` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `sapi`;

-- Volcando estructura para tabla sapi.almacen
CREATE TABLE IF NOT EXISTS `almacen` (
  `idAlmacen` int(11) NOT NULL COMMENT 'identificador del almacen',
  ...
  `cuentaContableAlmacen` int(11) DEFAULT NULL COMMENT 'cuana a la que pertece el alamcen',
  `statusAlamcen` varchar(15) DEFAULT NULL COMMENT 'estatus del almacen',
  PRIMARY KEY (`idAlmacen`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla sapi.almacen: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `cliente` (
  ...
  `statusSietema` int(11) DEFAULT 1 COMMENT 'este esta ligado a la tabla de statusCliente',
  `NunCuentaCliente` int(11) NOT NULL COMMENT 'numero de cuenta, este sera registrado en otra tabla',
...
CREATE TABLE IF NOT EXISTS `compras` (
  `idCompras` int(11) NOT NULL COMMENT 'identificador de compras',
  `NumeroDeNotasCompras` int(11) DEFAULT NULL COMMENT 'numero de las notas de la compra',
  `FechaCompra` date DEFAULT NULL COMMENT 'fecha que se realizo la compra',
  `almacen` int(11) DEFAULT NULL COMMENT 'id del alamcen que se se guardara el producto',
  `usuario_compra` int(11) DEFAULT NULL COMMENT 'identificador del usuario querecibe la compra',
...
CREATE TABLE IF NOT EXISTS `conceptomovinv` (
  `idConceptoMovIn` int(11) NOT NULL AUTO_INCREMENT COMMENT 'identificador de los conceptos',
...
CREATE TABLE IF NOT EXISTS `contactocliente` (
  `idContactoCliente` int(11) NOT NULL AUTO_INCREMENT COMMENT 'identofocador de los contacto de cliente',
  `ClienteId` int(11) NOT NULL COMMENT 'relacion con la tabla cliente,',
...
-- Volcando datos para la tabla sapi.contactocliente: ~21 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `contactoproveedor` (
  `idContactoProveedor` int(11) NOT NULL AUTO_INCREMENT COMMENT 'identificador del contacto proveedor',
  `proveedorId` int(11) NOT NULL COMMENT 'campo relacionado con la tabla proveedor',
  `nombreProveesor` varchar(50) NOT NULL COMMENT 'nombre completo del proveedor',
  `telefono1Proveedor` int(11) NOT NULL COMMENT 'telefono principal del proveedor',
  `telefono2proveedor` int(11) DEFAULT NULL COMMENT 'telefono secundario de proveedor',
...
-- Volcando datos para la tabla sapi.contactoproveedor: ~19 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `creditocliente` (
  `idCreditoCliente` int(11) NOT NULL AUTO_INCREMENT COMMENT 'identificador de cresito del cliente',
  `ClienteId` int(11) NOT NULL COMMENT 'campo relacionado con la tabla cliente',
  `fechaUltimoPagoCreditoCliente` date NOT NULL COMMENT 'fecha ultima de pago del cliente',
  `documentoUltimoCreditoCliente` int(11) NOT NULL COMMENT 'documento que pago el cliente',
  ...
  `documentoUltimaVentaCreditoCliente` int(11) NOT NULL COMMENT 'documento de ultima venta',
...
CREATE TABLE IF NOT EXISTS `cuentascontable` (
  `iduentaContable` int(10) NOT NULL AUTO_INCREMENT COMMENT 'identificador de la cuenta contable',
  `nombreCuentaContable` varchar(50) NOT NULL COMMENT 'nombre para identificar la cuenta contable',
  `desCuentaContable` text DEFAULT NULL COMMENT 'descripcion de la cuenta contable creada',
...
CREATE TABLE IF NOT EXISTS `detallecompra` (
  `idDetalleCompra` int(11) NOT NULL COMMENT 'indentificador de detalle de compra',
  `pzDetalleCompra` int(11) DEFAULT NULL COMMENT 'piezas compradas',
  ...
  `loteDetalleCompra` int(3) DEFAULT NULL,
  `idCompras` int(11) DEFAULT NULL,
  `idProducto` int(11) DEFAULT NULL,
  `idAlmacen` int(11) DEFAULT NULL,
  PRIMARY KEY (`idDetalleCompra`),
  KEY `IX_Relationship10` (`idCompras`),
  KEY `IX_Relationship2` (`idProducto`),
  KEY `IX_Relationship3` (`idAlmacen`),
  CONSTRAINT `pk_almacen_dCompras` FOREIGN KEY (`idAlmacen`) REFERENCES `almacen` (`idAlmacen`),
  CONSTRAINT `pk_compras_DetalleCompras` FOREIGN KEY (`idCompras`) REFERENCES `compras` (`idCompras`),
...
CREATE TABLE IF NOT EXISTS `domiciliocliente` (
  `idDomicilioCliente` int(11) NOT NULL AUTO_INCREMENT COMMENT 'identificador del domicilio',
  `clienteId` int(11) NOT NULL COMMENT 'campo relacionado con la tabla cliente',
  `rutaId` int(11) NOT NULL COMMENT 'campo relacionado con la tabla de ruta (aún no esta disponible esta tabla)',
  ...
  `estados_municipios_id` int(11) NOT NULL COMMENT 'este campo esta relcionado con la tabla estados_municipios, sabiendo el muinicpio sabemos el estado',
  `cpDomicilioCliente` int(5) NOT NULL COMMENT 'codigo postal del domicilio del cliente',
...
CREATE TABLE IF NOT EXISTS `domiclioproveedor` (
  `idDomicilioProveedor` int(11) NOT NULL AUTO_INCREMENT COMMENT 'identificador del domicilio del proveedor',
  `proveedorId` int(11) NOT NULL COMMENT 'campo relacionado con la tabla proveedor',
  ...
  `cpDomicilioProveedor` int(5) NOT NULL DEFAULT 11111 COMMENT 'codigo postal de la dirección del proveedor',
...
CREATE TABLE `getdomcliente` (
	`idDomicilioCliente` INT(11) NOT NULL COMMENT 'identificador del domicilio',
	`clienteId` INT(11) NOT NULL COMMENT 'campo relacionado con la tabla cliente',
	`rutaId` INT(11) NOT NULL COMMENT 'campo relacionado con la tabla de ruta (aún no esta disponible esta tabla)',
	`calleDomicilioCliente` VARCHAR(30) NOT NULL COMMENT 'calle donde esta el cliente' COLLATE 'utf8mb4_general_ci',
	`numeroDomicilioCliente` VARCHAR(5) NOT NULL COMMENT 'numero del domicilio' COLLATE 'utf8mb4_general_ci',
	`estados_municipios_id` INT(11) NOT NULL COMMENT 'este campo esta relcionado con la tabla estados_municipios, sabiendo el muinicpio sabemos el estado',
	`cpDomicilioCliente` INT(5) NOT NULL COMMENT 'codigo postal del domicilio del cliente',
	`coloniaDomicilioCliente` VARCHAR(80) NULL COMMENT 'colonia deñ dolicilio del cliente' COLLATE 'utf8mb4_general_ci',
	`idEstado` INT(11) NOT NULL,
	`estado` VARCHAR(100) NOT NULL COLLATE 'latin1_swedish_ci',
	`municipio` VARCHAR(100) NOT NULL COLLATE 'latin1_swedish_ci',
...
CREATE TABLE `getdomproveedor` (
	`idDomicilioProveedor` INT(11) NOT NULL COMMENT 'identificador del domicilio del proveedor',
	`proveedorId` INT(11) NOT NULL COMMENT 'campo relacionado con la tabla proveedor',
	`calleDomicilioPRoveedor` VARCHAR(50) NOT NULL COMMENT 'calle del domicilio de proveedor' COLLATE 'utf8mb4_general_ci',
	`numeroDomiclioProveedor` VARCHAR(5) NOT NULL COMMENT 'numero del domicilio del proveedor' COLLATE 'utf8mb4_general_ci',
	`municipioDomicilioProveedor` VARCHAR(50) NULL COLLATE 'utf8mb4_general_ci',
	`cpDomicilioProveedor` INT(5) NOT NULL COMMENT 'codigo postal de la dirección del proveedor',
	`coloniaProv` VARCHAR(80) NOT NULL COMMENT 'colonia donde se encuentra el domicilio del cliente' COLLATE 'utf8mb4_general_ci',
	`idMunicipio` INT(11) NOT NULL,
	`municipio` VARCHAR(100) NOT NULL COLLATE 'latin1_swedish_ci',
	`idEstado` INT(11) NOT NULL,
	`estado` VARCHAR(100) NOT NULL COLLATE 'latin1_swedish_ci'
...
CREATE TABLE `getprovcp` (
	`idProveedor` INT(11) NOT NULL COMMENT 'identificador de proveedor',
	`nombreProveesor` VARCHAR(50) NOT NULL COMMENT 'nombre completo del ptoveedor ' COLLATE 'utf8mb4_general_ci',
	`rfcProveedor` VARCHAR(13) NOT NULL COMMENT 'regustro federal del proveedor' COLLATE 'utf8mb4_general_ci',
	`statuSistema` INT(11) NOT NULL COMMENT 'status de la tabls de estatus sistema',
	`domPro` INT(11) NOT NULL COMMENT 'campo relacionado con la tabla proveedor',
	`calleDomicilioPRoveedor` VARCHAR(50) NOT NULL COMMENT 'calle del domicilio de proveedor' COLLATE 'utf8mb4_general_ci',
	`numeroDomiclioProveedor` VARCHAR(5) NOT NULL COMMENT 'numero del domicilio del proveedor' COLLATE 'utf8mb4_general_ci',
	`municipioDomicilioProveedor` VARCHAR(50) NULL COLLATE 'utf8mb4_general_ci',
	`cpDomicilioProveedor` INT(5) NOT NULL COMMENT 'codigo postal de la dirección del proveedor',
	`cpPro` INT(11) NOT NULL COMMENT 'campo relacionado con la tabla proveedor',
	`nombrePro` VARCHAR(50) NOT NULL COMMENT 'nombre completo del proveedor' COLLATE 'utf8mb4_general_ci',
	`telefono1Proveedor` INT(11) NOT NULL COMMENT 'telefono principal del proveedor',
	`telefono2proveedor` INT(11) NULL COMMENT 'telefono secundario de proveedor',
	`correoproveedor` VARCHAR(40) NULL COMMENT 'correo del proveedor no es obligatorio' COLLATE 'utf8mb4_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE IF NOT EXISTS `producto` (
  `idProducto` int(11) NOT NULL COMMENT 'identificador del produto',
  `DescripcionProducto` text DEFAULT NULL COMMENT 'descri´pcion de cada producto que hay en el inventario',
  `UnidadMedidaProducto` varchar(2) NOT NULL COMMENT 'unidad de la medida del producto',
  `existenciaProducto` int(6) DEFAULT NULL COMMENT 'total de esistencias en el que hay en el sistema',
  PRIMARY KEY (`idProducto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla sapi.producto: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `producto` DISABLE KEYS */;
/*!40000 ALTER TABLE `producto` ENABLE KEYS */;

-- Volcando estructura para tabla sapi.proveedor
CREATE TABLE IF NOT EXISTS `proveedor` (
  `idProveedor` int(11) NOT NULL AUTO_INCREMENT COMMENT 'identificador de proveedor',
...
-- Volcando datos para la tabla sapi.proveedor: ~12 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `roles` (
  `idRoles` int(11) NOT NULL AUTO_INCREMENT COMMENT 'identidicador de roles',
...
CREATE TABLE IF NOT EXISTS `ruta` (
  `idRuta` int(11) NOT NULL AUTO_INCREMENT COMMENT 'identificador de cada ruta',
...
CREATE TABLE `showproveedoredit` (
	...
	`rfcProveedor` VARCHAR(13) NOT NULL COMMENT 'regustro federal del proveedor' COLLATE 'utf8mb4_general_ci',
	`statuSistema` INT(11) NOT NULL COMMENT 'status de la tabls de estatus sistema',
	`idDomicilioProveedor` INT(11) NULL COMMENT 'identificador del domicilio del proveedor',
	`proveedorId` INT(11) NULL COMMENT 'campo relacionado con la tabla proveedor',
	`calleDomicilioPRoveedor` VARCHAR(50) NULL COMMENT 'calle del domicilio de proveedor' COLLATE 'utf8mb4_general_ci',
	`numeroDomiclioProveedor` VARCHAR(5) NULL COMMENT 'numero del domicilio del proveedor' COLLATE 'utf8mb4_general_ci',
	`municipioDomicilioProveedor` VARCHAR(50) NULL COLLATE 'utf8mb4_general_ci',
	`cpDomicilioProveedor` INT(5) NULL COMMENT 'codigo postal de la dirección del proveedor',
	`coloniaProv` VARCHAR(80) NULL COMMENT 'colonia donde se encuentra el domicilio del cliente' COLLATE 'utf8mb4_general_ci',
	`idEstado` INT(11) NOT NULL,
	`estado` VARCHAR(100) NOT NULL COLLATE 'latin1_swedish_ci',
	`idMunicipio` INT(11) NOT NULL,
	`municipio` VARCHAR(100) NOT NULL COLLATE 'latin1_swedish_ci'
...
CREATE TABLE IF NOT EXISTS `statusistema` (
  `idStatuSistema` int(11) NOT NULL COMMENT 'identificador del estatus',
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `getdomproveedor` AS select `dom`.`idDomicilioProveedor` AS `idDomicilioProveedor`,
        `dom`.`proveedorId` AS `proveedorId`,
		  `dom`.`calleDomicilioPRoveedor` AS `calleDomicilioPRoveedor`,
		  `dom`.`numeroDomiclioProveedor` AS `numeroDomiclioProveedor`,
		  `dom`.`municipioDomicilioProveedor` AS `municipioDomicilioProveedor`,
		  `dom`.`cpDomicilioProveedor` AS `cpDomicilioProveedor`,
		  `dom`.`coloniaProv` AS `coloniaProv`,
		  `mp`.`idMunicipio` AS `idMunicipio`,
		  `mp`.`municipio` AS `municipio`,
		  `es`.`idEstado` AS `idEstado`,
		  `es`.`estado` AS `estado` 
	from (
				(
					(`domiclioproveedor` `dom` 
						join `estados_municipios` `em` 
								on(
									 (`dom`.`municipioDomicilioProveedor` = `em`.`id`)
									)
					) join `municipios` `mp` 
								on(
										(`em`.`municipios_id` = `mp`.`idMunicipio`)
									)
				) 
				join `estados` `es` on(
												(`em`.`estados_id` = `es`.`idEstado`)
												)
			) ;
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `showproveedoredit` AS SELECT * FROM proveedor pr
left JOIN domiclioproveedor dp
ON pr.idProveedor = dp.proveedorId
INNER JOIN  estadomunicipio em
ON dp.municipioDomicilioProveedor =  em.idMunicipio ;
